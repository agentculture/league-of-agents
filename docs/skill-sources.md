...
league-of-agents vendors its `.claude/skills/` from **guildmaster** — the
...
Every vendored `SKILL.md` carries `type: command`. league-of-agents
...
#   - consumer-identifying prose: `guildmaster` → `league-of-agents` (NOT
...
If a re-sync would lose a league-of-agents adaptation, lift the change
...
#     → `which league-of-agents vendors from guildmaster`
