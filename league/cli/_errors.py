...
Every failure inside league-of-agents raises :class:`CliError`. The
top-level ``main()`` catches it, formats via :mod:`league.cli._output`,
...
# Exit-code policy. Documented in ``league-of-agents learn`` output.
# 0      = success
