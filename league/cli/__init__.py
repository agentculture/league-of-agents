...
from league.cli._output import emit_error

_ISSUES_URL = "https://github.com/agentculture/league-of-agents/issues"
...
def _build_parser() -> argparse.ArgumentParser:
    ...
    from league.cli._commands import cmatch as _cmatch_group
    ...
    parser = _CliArgumentParser(
        prog="league-of-agents",
        description="league-of-agents — a clonable template for AgentCulture mesh agents.",
    )
    parser.add_argument(
        "--version",
        action="version",
